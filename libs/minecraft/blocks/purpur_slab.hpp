...
constexpr static purpur_slab from_id(block_id_type id)
{
switch (id)
{
case 7872:
...
{
case true:
return "minecraft:purpur_slab:top:true";
case false:
return "minecraft:purpur_slab:top:false";
}
case type_type::bottom:
switch (waterlogged)
{
case true:
return "minecraft:purpur_slab:bottom:true";
case false:
return "minecraft:purpur_slab:bottom:false";
}
case type_type::double_:
switch (waterlogged)
{
case true:
return "minecraft:purpur_slab:double_:true";
case false:
return "minecraft:purpur_slab:double_:false";
}
}
}};
}   // namespace minecraft::blocks
